...
mod tests {
    ...
    proptest! {
        ...
        fn test_compute_from_state(
            ...
            let expected_balance: u64 = validator_setup.total_deposited_balance() + validator_setup.total_exited_balance();
            ...
            prop_assert_eq!(report.deposited_lido_validators, deposited_count + exited_count);
    ...
    proptest! {
        ...
        fn test_compute_and_compute_from_state_align(
            ...
            let report = ReportData::compute(refslot, refslot.epoch(), &validators.into(), &balances.into(), validator_setup.lido_creds);
