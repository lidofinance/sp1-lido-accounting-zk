...
abstract contract Sp1LidoAccountingReportContractBase {
    ...
    constructor(address _verifier, bytes32 _vkey, LidoValidatorState memory _initial_state) {
        verifier = _verifier;
        vkey = _vkey;
    ...
    function _verify(
        ...
        _require(metadata.old_state.merkle_root == old_state_hash, "Old state merkle_root mismatch");
    ...
    function _verify_public_values(
        ...
        _require(
            metadata.old_state.merkle_root == publicValues.metadata.old_state.merkle_root,
        ...
        _require(
            metadata.new_state.merkle_root == publicValues.metadata.new_state.merkle_root,
