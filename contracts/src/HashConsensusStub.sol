...
contract HashConsensusStub {
    ...
    constructor(uint256 refSlot, uint256 reportProcessingDeadlineSlot) {
        _refSlot = refSlot;
        _reportProcessingDeadlineSlot = reportProcessingDeadlineSlot;
    }

    function setCurrentFrame(uint256 refSlot, uint256 reportProcessingDeadlineSlot) external {
        _refSlot = refSlot;
        _reportProcessingDeadlineSlot = reportProcessingDeadlineSlot;
    }
